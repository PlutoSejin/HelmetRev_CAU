<?php
    ...
    $response = mysqli_query($conn, "SELECT * FROM BRAIN_WAVE_2 WHERE MACHINE_ID='$machineID' AND USER_ID = '$userID' AND INPUT_DATE BETWEEN '$startDate' AND '$endDate' ORDER BY INPUT_TIME_STAMP DESC");
